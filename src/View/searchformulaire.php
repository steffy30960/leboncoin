    ...
    <form method="GET" action="">
      ...
      <div class="col-sm-3 my-3">
        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="categorie">
          ...
          <option value="9">Téléphonie</option>
          <option value="10">Véhicule</option>
        </select>
      </div>
      <div class="form-row align-items-center">
        ...
        <div class="col-sm-3 my-3">
          <input type="integer" class="form-control" id="inlineFormInputDepartement" placeholder="Quel departement recherchez vous ?" name="departement">
        </div>
      </div>
